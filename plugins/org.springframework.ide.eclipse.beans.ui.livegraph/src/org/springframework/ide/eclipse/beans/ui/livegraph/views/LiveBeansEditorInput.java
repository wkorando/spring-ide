 ...
 * 
 */
public class LiveBeansEditorInput implements IEditorInput {

	LiveBeansModel model;

	public LiveBeansEditorInput(LiveBeansModel model) {
		this.model = model;
	}
	 ...
	 * @return the model
	 */
	public LiveBeansModel getModel() {
		return model;
	}
}
